var doodle = (function() {
    ...
    var requestAnimationFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(func) {
        setTimeout(func, 17);
    };
    ...
    var getRandomFormation = function(stage) {
        ...
        // বাংলাদেশের পতাকার রঙ (সবুজ এবং লাল)
        // প্রথম প্লেন: সবুজ (Green)
        formation.addPlane(0, 0, "0, 106, 78"); 
        // দ্বিতীয় প্লেন: লাল (Red) - একটু ডান পাশে (50px)
        formation.addPlane(50, 0, "244, 42, 65"); 
